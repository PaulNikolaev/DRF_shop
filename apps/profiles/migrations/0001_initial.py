    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_status', models.CharField(choices=[('PENDING', 'PENDING'), ('PACING', 'PACING'), ('SHIPPING', 'SHIPPING'), ('ARRIVING', 'ARRIVING'), ('SUCCESS', 'SUCCESS')], default='PENDING', max_length=20)),
